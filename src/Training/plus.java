...
public class plus extends JFrame {
	...
	public void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					plus frame = new plus(uname,fname);
	 ...
	 * Create the frame.
	 */
	public plus(String username, String firstname) {
		uname = username;
		fname = firstname;
	...
	public void initialize(){
		...
		Operator.setForeground(Color.ORANGE);
