...
public class multi extends JFrame {
	...
	public void main() {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					multi frame = new multi(uname,fname);
	 ...
	 * Create the frame.
	 */
	public multi(String username, String firstname) {
		uname = username;
		fname = firstname;
...
public void generateRandom(){
	...
	public void initialize(){
		...
		Number1 = new JLabel();
		Number1.setForeground(new Color(51, 204, 204));
		...
		Operator.setForeground(new Color(51, 204, 204));
